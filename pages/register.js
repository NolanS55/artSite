...
export default function Register(props){
  ...
  return (
    <>
      <Card bg="light">
        <Card.Body><h2>Register</h2>Register your account below</Card.Body>
      </Card>
      <br />
      <Form onSubmit={handleSubmit}>
        ...
        <br />
        <Form.Group>
          <Form.Label>Password:</Form.Label><Form.Control type="password" value={password2} id="password2" name="password2" onChange={e => setPassword2(e.target.value)} />
        </Form.Group>
